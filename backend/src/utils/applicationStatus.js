...
export const RECRUITER_APPLICATION_TRANSITIONS = Object.freeze({ submitted: ['under-review', 'shortlisted', 'rejected'], 'under-review': ['shortlisted', 'rejected'], shortlisted: ['assessment-pending', 'interview-scheduled', 'rejected'], 'assessment-pending': ['assessment-in-progress', 'rejected'], 'assessment-in-progress': ['assessment-completed'], 'assessment-completed': ['shortlisted', 'interview-scheduled', 'rejected'], 'interview-scheduled': ['interview-completed', 'rejected'], 'interview-completed': ['offer-pending', 'rejected'], 'offer-pending': ['offer-sent', 'rejected'], 'offer-sent': ['offer-accepted', 'offer-declined'], 'offer-accepted': ['hired'], 'offer-declined': ['shortlisted', 'rejected'] });
