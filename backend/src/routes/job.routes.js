...
import { closeManagedJob, createCompanyJob, deleteManagedJob, managedJob, managedJobs, pauseManagedJob, publicJob, publicJobs, publishManagedJob, resumeManagedJob, submitManagedJob, updateManagedJob } from '../controllers/job.controller.js';
...
import { jobCreateSchema, jobIdParamsSchema, jobSearchSchema, jobUpdateSchema, rejectJobSchema } from '../validators/job.validator.js';
