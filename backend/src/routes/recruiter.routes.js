...
for (const [path, controller] of [['approve', approveRecruiterAccount], ['reject', rejectRecruiterAccount], ['suspend', suspendRecruiterAccount], ['restore', restoreRecruiterAccount]]) {
